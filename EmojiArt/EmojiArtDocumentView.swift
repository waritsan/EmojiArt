                ...
                .navigationBarItems(trailing: Button(action: {
                    ...
                    Image(systemName: "doc.on.clipboard")
                        ...
                        .alert(isPresented: $explainBackgroundPaste) {
                            Alert(title: Text("Paste Background"), message: Text("Copy the URL of an image to the clip board and then touch this button to make it the background of your document"), dismissButton: .default(Text("Ok")))
                        }
                }))
            }
            .zIndex(-1)
